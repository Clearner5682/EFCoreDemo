...
namespace Web.Controllers
{
    public class HomeController : Controller
    {
        ...
        public HomeController(MyContext context,IDependencyService dependencyService1,IDependencyService dependencyService2,TextWriter textWriter,IRepository<string> strRepository,IRepository<int> intRepository,ILifetimeScope scope)
        {
            _context = context;
